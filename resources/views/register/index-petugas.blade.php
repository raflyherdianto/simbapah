...
<body class="">
    <main class="form-signin">
        ...
        @endif --}}
        <form action="/register-petugas" method="POST" class="user" enctype="multipart/form-data">
            @csrf
            <img class="mb-4" src="/img/login.jpg" alt="" width="200">
            <h1 class="h3 mb-3 fw-normal text-center">Register Petugas</h1>
            ...
            <div class="form-group mt-3">
                <label for="nik" class="form-label fs-6">NIK</label>
            ...
            <div class="form-group mt-3">
                <label for="jenis_kelamin" class="form-label fs-6">Jenis Kelamin</label>
            ...
            <div class="form-group mt-3">
                <label for="ttl" class="form-label fs-6">Tempat & Tanggal Lahir</label>
                <input type="text" class="form-control @error('ttl') is-invalid @enderror" id="ttl"
                    name="ttl" placeholder="Tanggal Lahir">
                @error('ttl')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
