    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Tambah Data Mitra</h1>
                <ol class="breadcrumb mb-4">
                    {{-- <li class="breadcrumb-item active">Dashboard</li> --}}
                </ol>
                <form class="row g-3" action="/dashboard/mitra" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label for="nama" class="form-label fs-5">Nama Mitra</label>
                    ...
                    <div class="col-md-6">
                        <label for="nomor_usaha" class="form-label fs-5">Nomor Usaha</label>
