...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <form class="row g-3 mt-2" action="/dashboard/profile/admin" method="POST"
                enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="col-12">
                    <label for="kode_user" class="form-label fs-5">Kode User</label>
                    <input class="form-control" type="text" value="{{ old('kode_user', auth()->user()->admin->kode_user) }}" name="kode_user" aria-label="readonly" readonly>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <label for="nama" class="form-label fs-6">Ubah Nama</label>
                ...
                <div class="col-md-6">
                    ...
                    value="{{ old('nik', auth()->user()->admin->nik) }}">
                    @error('nik')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('jenis_kelamin', auth()->user()->admin->jenis_kelamin) }}">
                    @error('jenis_kelamin')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('ttl', auth()->user()->admin->ttl) }}">
                    @error('ttl')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('alamat', auth()->user()->admin->alamat) }}">
                    @error('alamat')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('provinsi', auth()->user()->admin->provinsi) }}">
                    @error('provinsi')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kota', auth()->user()->admin->kota) }}">
                    @error('kota')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kecamatan', auth()->user()->admin->kecamatan) }}">
                    @error('kecamatan')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kelurahan', auth()->user()->admin->kelurahan) }}">
                    @error('kelurahan')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kode_pos', auth()->user()->admin->kode_pos) }}">
                    @error('kode_pos')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('no_hp', auth()->user()->admin->no_hp) }}">
                    @error('no_hp')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('rekening', auth()->user()->admin->rekening) }}">
                    @error('rekening')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    <input type="hidden" name="oldImage" value="{{ auth()->user()->admin->foto }}">
                    @if (auth()->user()->admin->foto)
                        <img src="{{ asset('storage/' . auth()->user()->admin->foto ) }}"
