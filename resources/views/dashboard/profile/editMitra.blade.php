...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <form class="row g-3 mt-2" action="/dashboard/profile/mitra" method="POST"
                enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="col-12">
                    <label for="kode_user" class="form-label fs-5">Kode User</label>
                    <input class="form-control" type="text" value="{{ old('kode_user', auth()->user()->mitra->kode_user) }}" name="kode_user"  aria-label="readonly input example" readonly>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    value="{{ old('nama', auth()->user()->mitra->nama) }}">
                    @error('nama')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('nomor_usaha', auth()->user()->mitra->nomor_usaha) }}">
                    @error('nomor_usaha')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('alamat', auth()->user()->mitra->alamat) }}">
                    @error('alamat')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('provinsi', auth()->user()->mitra->provinsi) }}">
                    @error('provinsi')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kota', auth()->user()->mitra->kota) }}">
                    @error('kota')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kecamatan', auth()->user()->mitra->kecamatan) }}">
                    @error('kecamatan')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kelurahan', auth()->user()->mitra->kelurahan) }}">
                    @error('kelurahan')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kode_pos', auth()->user()->mitra->kode_pos) }}">
                    @error('kode_pos')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('no_hp', auth()->user()->mitra->no_hp) }}">
                    @error('no_hp')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('rekening', auth()->user()->mitra->rekening) }}">
                    @error('rekening')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    <input type="hidden" name="oldImage" value="{{ auth()->user()->mitra->foto }}">
                    @if (auth()->user()->mitra->foto)
                        <img src="{{ asset('storage/' . auth()->user()->mitra->foto ) }}"
