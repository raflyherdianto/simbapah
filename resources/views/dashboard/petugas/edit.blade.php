...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <form class="row g-3 mt-2" action="/dashboard/petugas/{{ $petugase->id }}" method="POST"
                enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="col-12">
                    <label for="kode_user" class="form-label fs-5">Kode User</label>
                    <input class="form-control" type="text" value="{{ old('kode_user', $petugase->kode_user) }}" name="kode_user"  aria-label="readonly input example" readonly>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    value="{{ old('jenis_kelamin', $petugase->jenis_kelamin) }}">
                    @error('jenis_kelamin')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    value="{{ old('alamat', $petugase->alamat) }}">
                    @error('alamat')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('provinsi', $petugase->provinsi) }}">
                    @error('provinsi')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    value="{{ old('kecamatan', $petugase->kecamatan) }}">
                    @error('kecamatan')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kelurahan', $petugase->kelurahan) }}">
                    @error('kelurahan')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('kode_pos', $petugase->kode_pos) }}">
                    @error('kode_pos')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('no_hp', $petugase->no_hp) }}">
                    @error('no_hp')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    value="{{ old('rekening', $petugase->rekening) }}">
                    @error('rekening')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    <input type="hidden" name="oldImage" value="{{ $petugase->foto }}">
                    @if ($petugase->foto)
                        <img src="{{ asset('storage/' . $petugase->foto ) }}"
